...
local custom_mappings = {
  -- General
	{ "<leader>ve", ":edit ~/.config/nvim/init.lua<CR>", mode = "n", description = "Open config", opts = opts },
	{ "<leader>vk", ":edit ~/.config/nvim/lua/keymap.lua<CR>", mode = "n", description = "Open keymaps", opts = opts },
	{ "<leader>vl", ":edit ~/.config/nvim/lua/plugins/legendary.lua<CR>", mode = "n", description = "Open legendary keymaps", opts = opts },
	{ "<leader>vr", ":source %<CR>", mode = "n", description = "Source current file", opts = opts },
  -- Toggle file tree
  ...
  -- Commenting
	{ "gcc", ":CommentToggle<CR>", mode = 'v', opts = opts, description = "Toggle Comment" },
	{ "gcc", ":CommentToggle<CR>", mode = 'n', opts = opts, description = "Toggle Comment" },
  -- folding
